...
/**
 * It search the property value in service.properties, if the key is not there it search for the value in the
 * environment variables
 */
public class ServiceConfigurationDefault implements ServiceConfiguration {
    private final ServiceConfiguration environment;
    private final ServiceConfiguration properties;
